...
test('Creating and Assigning User Roles', async ({page}) => {
	...
	await fill(page, 'Title', 'Marketing Coordinator');
	await fill(page, 'Description', 'Clarity role for an individual contributor from the marketing team.');
	await fill(page, 'Key', 'Marketing Coordinator');
