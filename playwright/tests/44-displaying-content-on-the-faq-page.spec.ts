...
test('Displaying Content on the FAQ Page', async ({page}) => {
	...
	await capture(page, {name: 'building-enterprise-websites-with-liferay/06-content-authoring-and-management/06-displaying-claritys-content/images/14.png'});
	...
	await capture(page, {name: 'building-enterprise-websites-with-liferay/06-content-authoring-and-management/06-displaying-claritys-content/images/17.png'});
